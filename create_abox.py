        ...
        if pd.notna(row['venue']) and pd.notna(row['venue_type']):
            if row['venue_type'] == 'conference' or row['venue_type'] == 'workshop':
                ...
                if not matching_editions.empty:
                    ...
                    if edition['edition_id'] in editions:
                        edition_uri = editions[edition['edition_id']]
                        g.add((paper_uri, PUB.isPublishedIn, edition_uri))
                        g.add((edition_uri, PUB.containsPaper, paper_uri))
                ...
                if not matching_volumes.empty:
                    ...
                    if volume_key in volumes:
                        ...
                        g.add((volume_uri, PUB.containsPaper, paper_uri))
